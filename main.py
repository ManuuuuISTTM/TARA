...
@bot.command(name="s_talk", aliases=["talk"])
async def talk_command(ctx, *args, **kwargs):
    await ctx.send("😂 Sorry bhai, abhi baat nahi ho sakti! Dev bhai feature fix kar rahe hain, thoda intezaar karo, mast baat hogi fir. 🚧")
